# Add the rocker/shiny-verse image as an additional stage
...
RUN git clone https://github.com/your-username/your-shiny-app.git /srv/shiny-server/qpcr_data_manager
